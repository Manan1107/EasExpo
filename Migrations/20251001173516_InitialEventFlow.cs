...
{
    public partial class InitialEventFlow : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StallSize = table.Column<string>(maxLength: 100, nullable: true),
            ...
            migrationBuilder.CreateTable(
                name: "StallOwnerApplications",
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    UserId = table.Column<string>(nullable: false),
                    DocumentUrl = table.Column<string>(maxLength: 256, nullable: true),
                    AdditionalNotes = table.Column<string>(maxLength: 256, nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StallOwnerApplications", x => x.Id);
                    table.ForeignKey(
                        name: "FK_StallOwnerApplications_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Stalls_Events_EventId",
                        column: x => x.EventId,
                        principalTable: "Events",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Stalls_AspNetUsers_OwnerId",
                        column: x => x.OwnerId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TransactionReference = table.Column<string>(maxLength: 100, nullable: true),
                    Status = table.Column<int>(nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StallOwnerApplications_UserId",
                table: "StallOwnerApplications",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_Stalls_OwnerId",
                table: "Stalls",
                column: "OwnerId");

            migrationBuilder.CreateIndex(
                name: "IX_Stalls_EventId_SlotNumber",
                table: "Stalls",
